...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="This is a tutorial on argparse")
    parser.add_argument("--artifact_name", type=str, help="Name and version of W&B artifact", required=True)
    parser.add_argument("--optional_arg", type=float, help="An optional argument", required=False,
                        default=2.3)
